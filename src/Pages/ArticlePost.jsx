...
function NewArticlePost () {
  ...
  const [selectedImg, setSelectedImg]= React.useState("g");
...
<FadeIn
delay={800}>
              <div className='text-orange-800 text-3xl font-bold flex justify-center mb-5'> New Article</div>
           <div className='ml-4 mr-4  '>
              <TextField onChange={(e)=> setTitle(e.target.value)}
              fullWidth label="Title" color="warning"  />
            </div>
